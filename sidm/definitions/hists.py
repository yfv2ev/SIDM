...
hist_defs = {
    ...
    "lj0_e": h.Histogram(
        [
            h.Axis(hist.axis.Regular(350, 0, 700, name="lj_e",  label="Leading lepton jet E [GeV]"),
                   lambda objs: objs["ljs"][ak.num(objs["ljs"]) > 1, 0].p4.energy),
        ],
    ),
    "lj1_e": h.Histogram(
        [
            h.Axis(hist.axis.Regular(350, 0, 700, name="lj_e",  label="Subleading lepton jet E [GeV]"),
