...
evt_cut_defs = {
    ...
    "genAs_toE_matched_egmLj": lambda objs: ak.num(derived_objs["genAs_toE_matched_egmLj"](objs, 0.4)
                                [~ak.is_none(derived_objs["genAs_toE_matched_egmLj"](objs, 0.4), axis =1)]) >= 1,
    "genAs_toMu_matched_muLj": lambda objs: ak.num(derived_objs["genAs_toMu_matched_muLj"](objs,0.4)                                                           [~ak.is_none(derived_objs["genAs_toMu_matched_muLj"](objs, 0.4), axis =1)]) >= 1,
    "genAs_toE": lambda objs: ak.num(objs["genAs_toE"][~ak.is_none(objs["genAs_toE"], axis =1)]) >= 1,
    "genAs_toMu": lambda objs: ak.num(objs["genAs_toMu"][~ak.is_none(objs["genAs_toMu"], axis =1)]) >= 1,           
}
